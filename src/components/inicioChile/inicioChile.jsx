...
export const InicioChileComponent = () => {

    return(

        <div className='contenedor'>
        <main>
            <h1><img className="iconos" src="images/flechaderecha.svg" alt=''/>10 Lugares que debes visitar si vas a chile<img className="iconos" src="images/flechaizquierda.svg" alt=''/></h1>
            ...
            <div className="imagenes">
                <img className="fotos" src="images/chileBandera.png" alt="chile" />
            </div>

            <p>
                Primero que nada decir que la presente pagina tiene como finalidad dar a conocer aquellos sitios turisticos e increibles que posee Chile. Para ello en la siguiente informacion que se les mostrara son aquellos lugares que no te pueden faltar por visitar si viajas a Chile
            </p>

            <h2><img className="iconos" src="images/flechaderecha.svg" alt=''/>Laguna Roja, Camiña<img className="iconos" src="images/flechaizquierda.svg" alt=''/></h2>

            <div className="imagenes"> 
                <img className="fotos" src="images/lagunaRoja.jpg" alt="lagunaRoja" />
            </div>
            ...
            <h2><img className="iconos" src="images/flechaderecha.svg" alt=''/>Dientes de Navarino, Isla Navarino<img className="iconos" src="images/flechaizquierda.svg" alt=''/></h2>

            <div className="imagenes"> 
                <img className="fotos" src="images/islaNavarino.jpg" alt="IslaNavarino" />
            </div>

            <p>
                El trekking más austral del mundo será una increíble manera de desquitarse luego de meses en cuarentena. La naturaleza salvaje de la Patagonia chilena cala hondo en la mente del viajero durante los varios días de caminata que componen el circuito Dientes de Navarino. Este sendero de trekking ha crecido bastante en popularidad durante los últimos años, sin embargo la sensación de estar sobre el lugar más remoto de la tierra sigue intacta.
            </p>
            ...
            <h2><img className="iconos" src="images/flechaderecha.svg" alt=''/>Piedra de la Iglesia, Constitucion <img className="iconos" src="images/flechaizquierda.svg" alt=''/></h2>

            <div className="imagenes">
                <img className="fotos" src="images/Constitucion.jpg" alt="Constitucion" />
            </div>
            ...
            <h2><img className="iconos" src="images/flechaderecha.svg" alt=''/>Base Torres, Parque Nacional<img className="iconos" src="images/flechaizquierda.svg" alt=''/></h2>

            <div className="imagenes">
                <img className="fotos" src="images/torresdelPaine.jpg" alt="torresdelPaine" />
            </div>

            <p>
                Probablemente la caminata más popular de Chile, el trekking a la Base de las Torres del Paine es algo que debes hacer al menos una vez en tu vida. Una de las razones de por qué decidimos poner este lugar aquí es que debido a ser uno de los trekkings más transitados de todo Sudamérica, y luego de varios meses sin ser visitada por turistas, la belleza natural de la caminata estará completamente rejuvenecida.
            </p>
            ...
            <h2><img className="iconos" src="images/flechaderecha.svg" alt=''/>Cerro San Sebastian, Parque Nacional Huerquehue<img className="iconos" src="images/flechaizquierda.svg" alt=''/></h2>

            <div className="imagenes">
                <img className="fotos" src="images/parqueHuerquehue.jpg" alt="Parque" />
            </div>

            <p>
                La caminata al Cerro San Sebastián es la más gratificante en el Parque Nacional Huerquehue, pues ofrece una vista de 360 ​​grados de Coihues, Lengas y Araucarias además de 12 volcanes diferentes y numerosos lagos de distintas tonalidades.
            </p>
            ...
            <h2><img className="iconos" src="images/flechaderecha.svg" alt=''/>Salar de Maricunga, Parque Nevado Tres Cruces<img className="iconos" src="images/flechaizquierda.svg" alt=''/></h2>

            <div className="imagenes">
                <img className="fotos" src="images/parqueNevado.jpg" alt="ParqueNevado" />
            </div>
            ...
            <h2><img className="iconos" src="images/flechaderecha.svg" alt=''/>Volcan Calbuco, Reserva Nacional Llanquihue<img className="iconos" src="images/flechaizquierda.svg" alt=''/></h2>

            <div className="imagenes"> 
                <img className="fotos" src="images/reservaLlanquihue.jpg" alt="Llanquihue" />
            </div>
            ...
            <h2><img className="iconos" src="images/flechaderecha.svg" alt=''/>Valle de la Luna, San Pedro de Atacama<img className="iconos" src="images/flechaizquierda.svg" alt=''/></h2>

            <div className="imagenes">
                <img className="fotos" src="images/ValleLuna.jpg" alt="ValleLaLune" />
            </div>

            <p>
                Similar a lo que ocurre con Base Torres, el Valle de la Luna es uno de los lugares turísticos más visitados de Chile. Sin embargo, durante estos días de cuarentena, los vientos del desierto de seguro se han encargado de alterar el paisaje de forma única, eliminando la huella de los visitantes para otorgarle una sensación de virginidad al lugar.
            </p>
            ...
            <h2><img className="iconos" src="images/flechaderecha.svg" alt=''/>Piedra del Aguila, Parque Nacional Nahuelbuta<img className="iconos" src="images/flechaizquierda.svg" alt=''/></h2>

            <div className="imagenes"> 
                <img className="fotos" src="images/piedraelAguila.jpg" alt="piedraelAguila" />
            </div>
            ...
            <div className="imagenes"> 
                <img className="fotos" src="images/playaTopocalma.jpg" alt="playa" />
            </div>
