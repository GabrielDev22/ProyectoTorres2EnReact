...
export const InicioComponent = () => {
    ...
    return(
        ...
        <main>
            <h1><img className="iconos" src="images/flechaderecha.svg" alt="" />10 lugares que debes conocer en Venezuela <img className="iconos" src="images/flechaizquierda.svg" alt=""/></h1>
        ...
        <p> 
            A lo largo de su costa en el Caribe, hay islas turísticas tropicales, entre ellas la Isla de Margarita y el archipiélago Los Roques. 
        </p>
        <p>
             Al noroeste está la cordillera de los Andes y la ciudad colonial de Mérida, una base para visitar el Parque Nacional de la Sierra Nevada. Caracas, la capital, se encuentra en el norte.
        </p>

        <div className="imagenes"><img className="fotos" src="images/venezuela.png" alt="imagen-01"/></div>

        <p>
            Primero que nada decir que la presente pagina tiene como finalidad
            dar a conocer aquellos sitios turisticos e increibles que posee 
            Venezuela. Para ello en la siguiente informacion que se les mostrara son aquellos lugares que no te pueden faltar por visitar si viajas a Venezuela
        </p>

        <h2><img className="iconos" src="images/flechaderecha.svg" alt="" />Salto Angel<img className="iconos" src="images/flechaizquierda.svg" alt=""/></h2>

        <div className="imagenes"><img className="fotos" src="images/SaltoAngel.jpg" alt="imagen-02"/></div>
        ...
        <h2><img className="iconos" src="images/flechaderecha.svg" alt="" />El Monte Roraima<img className="iconos" src="images/flechaizquierda.svg" alt=""/></h2>

        <div className="imagenes"><img className="fotos" src="images/MonteRoraima.jpg" alt="imagen-03" /></div>
        ...
        <h2><img className="iconos" src="images/flechaderecha.svg" alt="" />El Delta del Orinico<img className="iconos" src="images/flechaizquierda.svg" alt=""/></h2>

        <div className="imagenes"><img className="fotos" src="images/DeltaOrinoco.jpg" alt="imagen-03" /></div>
        ...
        <h2><img className="iconos" src="images/flechaderecha.svg" alt="" />Cayo Sombrero <img className="iconos" src="images/flechaizquierda.svg" alt=""/></h2>
        
        <div className="imagenes"><img className="fotos" src="images/CayoSombrero.jpg" alt="imagen-04"/></div>
        ...
        <h2><img className="iconos" src="images/flechaderecha.svg" alt="" /> El Amazonas <img className="iconos" src="images/flechaizquierda.svg" alt=""/></h2>

        <div className="imagenes"><img className="fotos" src="images/Amazonas.jpg" alt="imagen-05" /></div>
        ...
        <h2><img className="iconos" src="images/flechaderecha.svg" alt="" /> Merida <img className="iconos" src="images/flechaizquierda.svg" alt=""/> </h2>

        <div className="imagenes"><img className="fotos" src="images/Merida.jpg" alt="imagen-06" /></div>
        ...
        <h2><img className="iconos" src="images/flechaderecha.svg" alt="" />Los Llanos <img className="iconos" src="images/flechaizquierda.svg" alt=""/></h2>
        
        <div className="imagenes"><img class="fotos" src="images/LlanosVenezuela.jpg" alt="imagen-07" /></div>
        ...
        <h2><img className="iconos" src="images/flechaderecha.svg" alt="" />Puerto Colombia <img className="iconos" src="images/flechaizquierda.svg" alt=""/></h2>

        <div className="imagenes"><img class="fotos" src="images/PuertoColombia.jfif" alt="imagen-08" /></div>
        ...
        <h2><img className="iconos" src="images/flechaderecha.svg" alt="" />Los Medanos de Coro <img className="iconos" src="images/flechaizquierda.svg" alt=""/></h2>

        <div className="imagenes"><img class="fotos" src="images/MedanosCoro.jpeg" alt="imagen-09"/></div>
        ...
        <h2><img className="iconos" src="images/flechaderecha.svg" alt="" /> Parque Mochina <img className="iconos" src="images/flechaizquierda.svg" alt=""/> </h2>

        <div className="imagenes"><img class="fotos" src="images/ParqueMochina.jpg" alt="imagen-10" /></div>
